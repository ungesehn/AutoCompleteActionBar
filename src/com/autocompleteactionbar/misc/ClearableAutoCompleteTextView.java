...
/**
 * sub class of {@link android.widget.AutoCompleteTextView} that includes a
 * clear (dismiss / close) button with a OnClearListener to handle the event of
 * clicking the button based on code from {@link http
 * ://www.gubed.net/clearableautocompletetextview}
 * 
